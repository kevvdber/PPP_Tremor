...
function FirstLevel_PPI_kevvdber_28AUG2025(cohort, cSub, modelName)
%DISCUSS WITH FREEK
...
dirTremReg = '/project/3024011.01/TremorProject/analyses/kevin/TremorNetwork/POMVisit1/EMG/rest/processing/prepemg/Regressors/PPI';
cTremorFile_SearchPattern = fullfile(dirTremReg, strcat(cSub, "*.mat"));
...
% allReg.(string(cTremorData.names(1))) = cTremorData.R(:,1); %PPI
% allReg.(string(cTremorData.names(2))) = cTremorData.R(:,2); %VOI
% allReg.(string(cTremorData.names(3))) = cTremorData.R(:,3); %Tremor linear regressor
...
% matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'PPI_pos';
% matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [1 0 0];
% matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
% matlabbatch{1}.spm.stats.con.consess{2}.tcon.name = 'PPI_neg';
% matlabbatch{1}.spm.stats.con.consess{2}.tcon.weights = [-1 0 0];
% matlabbatch{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
% matlabbatch{1}.spm.stats.con.consess{3}.tcon.name = 'VOI';
% matlabbatch{1}.spm.stats.con.consess{3}.tcon.weights = [0 1 0];
% matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
% matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = 'Trem';
